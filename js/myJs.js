...
function firstQuestion(){
    ...
    Swal.fire({
        title: 'He luu Oppa',
        text: 'Người Yêu Anh có điều này muốn hỏi, nhớ phải trả lời thật lòng nha',
...
function textGenerate() {
    var n = "";
    var text = " Tại vì em siêu siêu xinh gái luôn, đã thế còn hiền lành, tốt tính, đáng yêu siêu siêu cấp nữa :<<<<<<< ";
...
$('#yes').click(function() {
    ...
    audio.play();
    Swal.fire({
        title: 'Nói cho em biết lý do vì sao anh yêu em đi <3',
        html: true,
        width: 900,
        padding: '3em',
